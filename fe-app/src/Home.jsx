...
export default function Home() {
  ...
  const getTeam = async () => {
    const respone20 = await fetch(
      "https://localhost:5001/neo4j/getWinrate/2020"
    );
    const data20 = await respone20.json();
    setTeams20(data20);

    const respone19 = await fetch(
      "https://localhost:5001/neo4j/getWinrate/2019"
    );
    const data19 = await respone19.json();
    setTeams19(data19);

    const respone18 = await fetch(
      "https://localhost:5001/neo4j/getWinrate/2018"
    );
